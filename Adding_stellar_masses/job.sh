...
#PBS -o /gpfs/home/jd925/Adding_stellar_masses/logs/job_70_output.log
#PBS -e /gpfs/home/jd925/Adding_stellar_masses/logs/job_70_error.log
...
python -u $WORKDIR/Running_sims.py 2>&1 | tee $WORKDIR/logs/live_70_output.log
