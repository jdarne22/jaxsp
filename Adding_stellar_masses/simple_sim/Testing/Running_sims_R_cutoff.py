...
for r_cut_kpc in r_cuts:
    ...
    checkpoint_dir=f'/gpfs/home/jd925/Adding_stellar_masses/Checkpoints/R_cutoff/checkpoints_{mode_tag}m22_{m22}_r0_{R0}_Lout_{L_out_frac}')
