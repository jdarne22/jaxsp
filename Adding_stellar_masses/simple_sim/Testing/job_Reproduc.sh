...
#PBS -o /gpfs/home/jd925/Adding_stellar_masses/simple_sim/logs/job_10_reproduc_output.log
#PBS -e /gpfs/home/jd925/Adding_stellar_masses/simple_sim/logs/job_10_reproduc_error.log
...
python -u $WORKDIR/Testing/Running_sims_reproduc.py 2>&1 | tee $WORKDIR/logs/live_10_reproduc_output.log
