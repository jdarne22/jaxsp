...
#PBS -o /gpfs/home/jd925/Adding_stellar_masses/simple_sim/logs/job_10_L_reduc_output.log
#PBS -e /gpfs/home/jd925/Adding_stellar_masses/simple_sim/logs/job_10_L_reduc_error.log
...
python -u $WORKDIR/Testing/Running_sims_L_reduc.py 2>&1 | tee $WORKDIR/logs/live_10_L_reduc_output.log
