...
for R0 in R0:
    ...
    sim.run_simulation(checkpoint_dir=f'/rds/general/user/jd925/home/PhD_first_year/jaxsp/Adding_stellar_masses/Checkpoints/checkpoints_m22_{m22}_r0_{R0}_Lout_{L_out_frac}')
