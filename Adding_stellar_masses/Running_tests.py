...
sys.path.insert(0, "/rds/general/user/jd925/home/PhD_first_year/jaxsp/Adding_stellar_masses/Tests/Testing_sim_methods/")
...
sim.run_simulation(checkpoint_dir=f'/rds/general/user/jd925/home/PhD_first_year/jaxsp/Adding_stellar_masses/Checkpoints/checkpoints_frozen_m22_{m22}_r0_{R0}_Lout_{L_out_frac}')
...
plt.savefig(f'/home/joshua/PhD_year_1/jaxsp/Adding_stellar_masses/Plots/Sim_tests/frozen_lf_m{m22}_R{R0}.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(f'/home/joshua/PhD_year_1/jaxsp/Adding_stellar_masses/Plots/Sim_tests/frozen_lf_eng_amom_m{m22}_R{R0}.png', dpi=300, bbox_inches='tight')
plt.close()
...
df.to_csv(f'/home/joshua/PhD_year_1/jaxsp/Adding_stellar_masses/Plots/Sim_tests/frozen_lf_data_m{m22}_R{R0}.csv', index=False)
